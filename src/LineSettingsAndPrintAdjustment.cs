...
public static class LineSettingsAndPrintAdjustment
{
        ...
        EncoderType encoderType)
    {
        ...
        if (characterHeightAdjustment is >= 20 and <= 200)
        {
        ...
        else
        {
            throw new ArgumentException(
                $"Character Height Adjustment Invalid (20 to 200): {characterHeightAdjustment}");
        }

        if (characterWidthAdjustment is >= 20 and <= 500)
        {
            _characterWidthAdjustment = characterWidthAdjustment;
        }
        else
        {
            throw new ArgumentException($"Character Width Adjustment Invalid (20 to 500): {characterWidthAdjustment}");
        }
